...
<x-container>
    ...
    <x-card title="Ajout d'une nouvelle couleur">

        <div class="card-body">
            <x-form :route="route('color.store')">
                <p class="h3 fw-bold text-center mt-4 mb-2">Informations</p>
                <x-form.input class="my-1" field="name" label="Nom de la couleur *" />
                <div class="d-flex justify-content-center">
                    <div class="test col-12">
                        <input type="color" id="color" name="color_code" value="#FFD700">
                        <div class="info">
                            <h5>Color picker</h5>
