...
<x-container>
    ...
    <x-card title="Ajout d'un nouveau matériau / revetement">

        <div class="card-body">
            <x-form :route="route('social_media.store')">
                <x-form.input class="my-1" field="name" label="Nom *" />
                <x-form.input class="my-1" field="link" label="Lien *" />
                <x-form.input class="my-1" field="img_name" label="Logo *" />
                <div>
